    ...
    <nav className="bg-[#0a0a1a] border-b border-[#00ffff33] shadow-[0_0_20px_rgba(0,255,255,0.1)]">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Desktop Profile - Moved right with ref */}
          <div className="hidden md:flex items-center space-x-4" ref={profileRef}>
            <div className="relative">
              ...
              {/* Profile Dropdown - Increased z-index */}
              {isProfileMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-[#0f0f1f] rounded-md border border-[#00ffff33] shadow-[0_0_30px_rgba(0,255,255,0.2)] py-1 z-50">
                  <Link 
                    to="/profile" 
                    className="block px-4 py-2 text-sm text-[#d0d0f0] hover:bg-[#00ffff11] flex items-center"
                    onClick={() => setIsProfileMenuOpen(false)}
