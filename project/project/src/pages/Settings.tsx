      ...
      >
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-neon-cyan">Dark Mode</h2>
              <p className="text-cyber-gray">Adjust the appearance</p>
            </div>
            <button
              onClick={() => setDarkMode(!darkMode)}
              className={`relative rounded-full w-12 h-6 transition-colors duration-200 focus:outline-none ${
                darkMode ? 'bg-neon-cyan' : 'bg-gray-200'
              }`}
            >
              <span
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-neon-cyan">Notifications</h2>
              <p className="text-cyber-gray">Manage your notifications</p>
            </div>
            <button
        ...
        >
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-neon-cyan">Language</h2>
            <select
              value={language}
              onChange={(e) => setLanguage(e.target.value)}
              className="w-full p-3 bg-cyber-deep border-2 border-neon-cyan rounded-lg text-cyber-gray focus:outline-none focus:ring-2 focus:ring-neon-magenta"
            >
